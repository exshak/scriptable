...
if (config.runsInWidget) {
  ...
  // You can add your own code here to add additional items to the "invisible" background of the widget.
  ...
  message =
    "Your widget background is ready. Would you like to use it as this script's background, or export the image for use in a different script or another widget app?"
